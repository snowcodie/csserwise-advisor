    ...
    <div class="two-content-div">
      ...
      <div>
        <div class="colomn-content-div">
          <div>
            <span class="title">Mange Slots</span><br>
            <span>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,<br>
              sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.
              Neque porro quisquam est.</span><br>
            <a href="viewslots.jsp"><button class="button">Click Here</button></a>
          </div>
        </div>
      </div>
    </div>
