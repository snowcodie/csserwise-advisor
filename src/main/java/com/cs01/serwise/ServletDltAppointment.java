...
@WebServlet(name = "ServletDltAppointment", value = "/ServletDltAppointment")
public class ServletDltAppointment extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement psd=con.prepareStatement("DELETE FROM serwise.appoinment WHERE Appoinment_Id=?");
